...
**Moraleja del final:** Kira y Toby, felices y orgullosos, aprenden la lección de cuidar la naturaleza.
...
Escena 12: **Moraleja del final:** Kira y Toby, felices y orgullosos, aprenden la lección de cuidar la naturaleza.

Lugar: túnel de árboles con iluminación cálida de hora dorada, luz suave y soñadora.


PERSONAJE SECUNDARIO - CIERVO GENTIL:
- Especie: ciervo joven
- Altura: 0.9x altura de Kira
- Forma del cuerpo: 
- Colores: fur: #BC6C25, belly: #FEFAE0
- Accesorios: 
- PROHIBIDO (para consistencia visual): no aumentar tamaño de astas

ELEMENTO DESTACADO: piedra de color blanco puro
...
Descripción: **Moraleja del final:** Kira y Toby, felices y orgullosos, aprenden la lección de cuidar la naturaleza.

Duración: 15-30 segundos

Estilo: Película animada 3D de alta calidad, dirigida a audiencia infantil.

Locación: túnel de árboles

PERSONAJES EN PANTALLA:
- Kira y Toby interactuando de forma dinámica y expresiva
- ciervo gentil (con características visuales consistentes)
