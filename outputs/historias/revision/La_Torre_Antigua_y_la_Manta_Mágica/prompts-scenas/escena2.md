...
Los perritos descubren la manta naranja brillante debajo de un cofre polvoriento.
...
Escena 2: Los perritos descubren la manta naranja brillante debajo de un cofre polvoriento.

Lugar: torre antigua con iluminación cálida de hora dorada, luz suave y soñadora.


PERSONAJE SECUNDARIO - DELFÍN JUGUETÓN:
- Especie: delfín
- Altura: 0.8x altura de Kira
- Forma del cuerpo: 
- Colores: skin: #90E0EF, belly: #CAF0F8
- Accesorios: pulsera coral #FF6B6B
- PROHIBIDO (para consistencia visual): no cambiar tono azul

ELEMENTO DESTACADO: manta de color naranja brillante
...
Descripción: Los perritos descubren la manta naranja brillante debajo de un cofre polvoriento.

Duración: 15-30 segundos

Estilo: Película animada 3D de alta calidad, dirigida a audiencia infantil.

Locación: torre antigua

PERSONAJES EN PANTALLA:
- Kira y Toby interactuando de forma dinámica y expresiva
- delfín juguetón (con pulsera coral #FF6B6B)
