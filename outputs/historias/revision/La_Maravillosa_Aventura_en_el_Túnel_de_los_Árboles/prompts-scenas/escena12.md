...
Kira y Toby celebrando, abrazados con el ratoncito inventor.
...
Escena 12: Kira y Toby celebrando, abrazados con el ratoncito inventor.

Lugar: túnel de árboles con iluminación cálida de hora dorada, luz suave y soñadora.


PERSONAJE SECUNDARIO - RATONCITO INVENTOR:
- Especie: ratón
- Altura: 0.45x altura de Kira
- Forma del cuerpo: 
- Colores: fur: #BDB2A7, ear: #FFD6E0
- Accesorios: lentes plateadas #C0C0C0
- PROHIBIDO (para consistencia visual): no variar tamaño de orejas

ELEMENTO DESTACADO: caja de color rojo oscuro
...
Descripción: Kira y Toby celebrando, abrazados con el ratoncito inventor.
...
- ratoncito inventor (con lentes plateadas #C0C0C0)
