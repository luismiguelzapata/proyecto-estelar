...
Kira y Toby celebrando el éxito con la mariposa aterrizando en la brújula.
...
Escena 12: Kira y Toby celebrando el éxito con la mariposa aterrizando en la brújula.

Lugar: casa en el árbol con iluminación cálida de hora dorada, luz suave y soñadora.


PERSONAJE SECUNDARIO - MARIPOSA BRILLANTE:
- Especie: mariposa mágica
- Altura: 0.4x altura de Kira
- Forma del cuerpo: 
- Colores: wing: gradiente fijo #FF9EEB a #A0C4FF
- Accesorios: brillo dorado sutil
- PROHIBIDO (para consistencia visual): no alterar patrón ni colores

ELEMENTO DESTACADO: escoba de color gris claro
